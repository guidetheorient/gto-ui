...
var GButton$1 = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["render", _sfc_render$2], ["__scopeId", "data-v-3136dae6"]]);
var GButton = {
  install(app) {
...
var GRow = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["render", _sfc_render$1]]);
    ...
    const classes = computed(() => {
      ...
      pos.forEach((key) => {
        ...
        if (typeof value === "number") {
          if (key === "span") {
            classes2.push(`${ns2}-${value}`);
          } else {
            classes2.push(`${ns2}-${key}-${value}`);
          }
        }
      });
...
var GCol = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["render", _sfc_render]]);
var GLayout = {
  install(app) {
...
const _hoisted_1$m = { class: "g-message__content" };
const _sfc_main$m = {
  props: {
    type: {
      type: String,
  ...
  setup(__props, { expose }) {
    const props = __props;
    function useTransition2({ placement }, calcPosition2) {
    ...
    const classes = computed(() => {
      const classes2 = [`${ns2}-${props.placement}`];
      if (props.type) {
        classes2.push(`${ns2}--${props.type}`);
      }
      return classes2;
    });
    ...
    const { beforeEnter, enter, leave } = useTransition2(props, calcPosition);
    const close = () => {
      visible.value = false;
    };
    expose({ close });
      ...
      return openBlock(), createBlock(Transition, {
        ...
        default: withCtx(() => [
          visible.value ? (openBlock(), createElementBlock("div", {
            ...
            createElementVNode("div", _hoisted_1$m, toDisplayString(__props.message), 1)
...
const message = (options = {}) => {
  const messageApp = createApp(_sfc_main$m, options);
...
const _sfc_main$l = /* @__PURE__ */ Object.assign(__default__$l, {
  props: {
    size: {
      type: [String, Number],
...
const _sfc_main$k = /* @__PURE__ */ Object.assign(__default__$k, {
  props: {
    visible: {
      type: Boolean,
      default: null
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass([ns2 + "__trigger"]),
        ref_key: "triggerRef",
        ref: triggerRef,
        ...
        createVNode(Transition, { name: "g-tooltip-fade" }, {
          default: withCtx(() => [
            withDirectives(createElementVNode("div", {
              class: normalizeClass([ns2, `${ns2}--${__props.placement}`]),
              ref_key: "tooltipRef",
              ref: tooltipRef,
              style: normalizeStyle(unref(style))
            }, [
...
const _sfc_main$j = /* @__PURE__ */ Object.assign(__default__$j, {
  props: {
    model: {
      type: Object,
      default: () => ({})
...
const _sfc_main$i = /* @__PURE__ */ Object.assign(__default__$i, {
  props: {
    label: {
      type: String,
      default: ""
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        __props.label ? (openBlock(), createElementBlock("label", {
          key: 0,
          class: normalizeClass([ns2 + "__label", { "g-form-item__label-required": unref(isRequired) }])
        }, toDisplayString(__props.label), 3)) : createCommentVNode("", true),
        createElementVNode("div", {
          class: normalizeClass([ns2 + "__content"])
        }, [
          renderSlot(_ctx.$slots, "default"),
          validateState.value === "error" ? (openBlock(), createElementBlock("div", _hoisted_1$l, toDisplayString(validateMessage.value), 1)) : createCommentVNode("", true)
        ], 2)
      ], 2);
    };
  }
...
const _sfc_main$h = /* @__PURE__ */ Object.assign(__default__$h, {
  props: {
    modelValue: {
      type: String,
      default: ""
...
var MinusOutlined = defineComponent({
  ...
  render: function render9(_ctx, _cache) {
    return openBlock(), createElementBlock("svg", _hoisted_1$b, _hoisted_3$2);
  }
});
const _hoisted_1$a = {
  xmlns: "http://www.w3.org/2000/svg",
...
var PlusOutlined = defineComponent({
  ...
  render: function render10(_ctx, _cache) {
    return openBlock(), createElementBlock("svg", _hoisted_1$a, _hoisted_5);
  }
});
const _hoisted_1$9 = {
  xmlns: "http://www.w3.org/2000/svg",
...
const _hoisted_1$8 = ["value", "disabled"];
const __default__$g = {
  name: "GInputNumber",
  inheritAttrs: false,
  directives: {
...
const _sfc_main$g = /* @__PURE__ */ Object.assign(__default__$g, {
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        class: normalizeClass([ns2, { "is-disabled": __props.disabled }])
      }, [
        withDirectives((openBlock(), createElementBlock("button", {
          class: normalizeClass([ns2 + "__minus", { "is-disabled": __props.min >= __props.modelValue || __props.disabled }])
        }, [
        ...
        withDirectives((openBlock(), createElementBlock("button", {
          class: normalizeClass([ns2 + "__plus", , { "is-disabled": __props.max <= __props.modelValue || __props.disabled }])
        }, [
          createVNode(_sfc_main$l, null, {
            default: withCtx(() => [
...
const _hoisted_1$7 = ["onMouseenter", "onClick"];
const __default__$f = {
  name: "GCarousel"
};
const _sfc_main$f = /* @__PURE__ */ Object.assign(__default__$f, {
  ...
  setup(__props) {
    ...
    function removeItem(uid2) {
      const i = items.value.findIndex((item) => item.uid === uid2);
      if (i > -1) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", {
          class: normalizeClass([ns2 + "__container"]),
          style: normalizeStyle({ height: __props.height })
        }, [
          renderSlot(_ctx.$slots, "default"),
          createElementVNode("div", {
            class: normalizeClass([ns2 + "__arrow-group"])
          }, [
            createElementVNode("button", {
              class: normalizeClass([ns2 + "__arrow"]),
              onClick: prev
            }, [
              createVNode(_sfc_main$l, null, {
                default: withCtx(() => [
        ...
        createElementVNode("ul", {
          class: normalizeClass([ns2 + "__dots"])
        }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(items.value, (item, i) => {
            return openBlock(), createElementBlock("li", {
              class: normalizeClass([ns2 + "__dot", { "is-active": activeIndex.value === i }]),
              key: i,
...
const _sfc_main$e = /* @__PURE__ */ Object.assign(__default__$e, {
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass([ns2, { "is-animating": animating.value }]),
        style: normalizeStyle(unref(style))
      }, [
        renderSlot(_ctx.$slots, "default")
      ], 6);
...
const _hoisted_1$6 = ["disabled", "checked"];
const __default__$d = {
  name: "GRadio"
};
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("label", {
        ...
        createElementVNode("span", {
          class: normalizeClass([ns2 + "__input-wrapper"])
        }, [
          createElementVNode("span", {
            class: normalizeClass([ns2 + "__input-border"])
          }, null, 2),
          createElementVNode("span", {
            class: normalizeClass([ns2 + "__input-circle"])
          }, null, 2),
          createElementVNode("input", {
            type: "radio",
            class: normalizeClass([ns2 + "__input"]),
        ...
        createElementVNode("span", {
          class: normalizeClass([ns2 + "__label"])
        }, [
          renderSlot(_ctx.$slots, "default", {}, () => [
        ...
        createElementVNode("span", {
          ...
          createElementVNode("span", {
            ...
            createVNode(_sfc_main$l, {
              class: normalizeClass([ns2 + "__icon"])
            }, {
              default: withCtx(() => [
...
const _hoisted_1$4 = ["value", "readonly", "disabled"];
...
const _sfc_main$9 = /* @__PURE__ */ Object.assign(__default__$9, {
  ...
  setup(__props, { emit }) {
    ...
    function removeOption(uid2) {
      let i = options.value.findIndex((option) => option.uid === uid2);
      if (i > -1) {
    ...
    return (_ctx, _cache) => {
      return withDirectives((openBlock(), createElementBlock("div", {
        class: normalizeClass([ns2, { active: visible.value, disabled: __props.disabled }]),
        ...
        createElementVNode("div", {
          ...
          __props.multiple ? (openBlock(), createElementBlock("div", {
            key: 0,
            class: normalizeClass([ns2 + "__tags"]),
            ref_key: "tagsRef",
            ref: tagsRef
          }, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(selected.value, (option) => {
              return openBlock(), createElementBlock("span", {
                class: normalizeClass([ns2 + "__tag"]),
                key: option.value
              }, [
                createTextVNode(toDisplayString(option.label) + " ", 1),
                createVNode(_sfc_main$l, {
                  class: normalizeClass([ns2 + "__icon-close"]),
            ...
            __props.filterable ? withDirectives((openBlock(), createElementBlock("input", {
              ...
              class: normalizeClass([ns2 + "__filter-input"]),
              type: "text",
          ...
          createElementVNode("input", {
            class: normalizeClass([ns2 + "__input", { multiple: __props.multiple }]),
            ref_key: "inputRef",
            ref: inputRef,
          ...
          createVNode(_sfc_main$l, {
            class: normalizeClass([ns2 + "__icon-select", { active: visible.value }])
          }, {
            default: withCtx(() => [
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return withDirectives((openBlock(), createElementBlock("li", {
        class: normalizeClass([ns2, { active: unref(active), disabled: __props.disabled }]),
        onClick: withModifiers(onOptionClick, ["stop"])
      }, [
        unref(multiple) ? (openBlock(), createBlock(_sfc_main$b, {
          key: 0,
          value: __props.value,
          disabled: __props.disabled
        }, {
      ...
      return visible.value ? (openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", {
          ...
          title.value ? (openBlock(), createElementBlock("p", {
            key: 0,
            class: normalizeClass([ns2 + "__desc"])
...
const relativeCls$2 = "g-relative";
var loadingDirective = {
  mounted(el, binding) {
    const app = createApp(_sfc_main$6);
    const instance = app.mount(document.createElement("div"));
    const name = _sfc_main$6.name;
    if (!el[name]) {
      el[name] = {};
    }
...
function append(el) {
  ...
  if (!["relative", "absolute", "fixed"].includes(style.position)) {
    addClass(el, relativeCls$2);
  }
  const $el = el[_sfc_main$6.name].instance.$el;
  if (el[_sfc_main$6.name].instance._fullscreen) {
...
const loading = (options = {}) => {
  const loadingApp = createApp(_sfc_main$6, options);
...
const _sfc_main$5 = /* @__PURE__ */ Object.assign(__default__$5, {
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass([ns2, { disabled: __props.disabled }]),
        ...
        createElementVNode("div", {
          class: normalizeClass([ns2 + "__circle"])
        }, [
          renderSlot(_ctx.$slots, "circle", {}, () => [
            __props.loading ? (openBlock(), createBlock(_sfc_main$l, {
              key: 0,
              class: normalizeClass([ns2 + "__loading"])
            }, {
              default: withCtx(() => [
                createVNode(unref(LoadingOutlined))
              ]),
              _: 1
            }, 8, ["class"])) : (openBlock(), createBlock(_sfc_main$l, { key: 1 }, {
              default: withCtx(() => [
        ...
        createElementVNode("div", {
          class: normalizeClass([ns2 + "__active-text"])
        }, [
        ...
        createElementVNode("div", {
          class: normalizeClass([ns2 + "__inactive-text"])
        }, [
        ...
        createElementVNode("div", {
          class: normalizeClass([ns2 + "__background"]),
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(Teleport, {
        ...
        createVNode(Transition, {
          ...
          default: withCtx(() => [
            withDirectives(createElementVNode("div", {
              class: normalizeClass([ns2 + "__wrapper"])
            }, [
              createElementVNode("div", {
                class: normalizeClass([ns2 + "__mask"]),
              ...
              createElementVNode("div", {
                ...
                _ctx.$slots.header || __props.title || __props.showClose ? (openBlock(), createElementBlock("div", {
                  key: 0,
                  class: normalizeClass([ns2 + "__header"])
                }, [
                  createElementVNode("span", {
                    class: normalizeClass([ns2 + "__title"])
                  }, toDisplayString(__props.title), 3),
                  renderSlot(_ctx.$slots, "header"),
                  createVNode(_sfc_main$l, {
                    class: normalizeClass([ns2 + "__close"]),
                    onClick: close
                  }, {
                    default: withCtx(() => [
                      createVNode(unref(CloseOutlined))
                ...
                _ctx.$slots.footer ? (openBlock(), createElementBlock("div", {
                  key: 1,
                  class: normalizeClass([ns2 + "__footer"])
                }, [
...
var defaultImage = "data:image/svg+xml;base64,";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("img", {
          style: normalizeStyle({ width: __props.imageWidth + "px" }),
          src: __props.image,
          alt: ""
...
function createLoadingLikeDirective(Comp, getProps2) {
  return {
    mounted(el, binding) {
      const app = createApp(Comp, getProps2(el, binding));
      const instance = app.mount(document.createElement("div"));
    ...
    updated(el, binding) {
      if (binding.value !== binding.oldValue) {
        binding.value ? append2(el) : remove2(el);
      }
    }
  };
  function append2(el) {
...
function getProps(el, binding) {
  return {
    description: el.getAttribute("g-empty-description") || void 0,
    imageWidth: el.getAttribute("g-empty-image-width") || void 0,
    image: el.getAttribute("g-empty-image") || void 0
  };
}
var emptyDirective = createLoadingLikeDirective(_sfc_main$3, getProps);
var GEmpty = {
  install(app) {
...
var Actions = {
  ...
  render() {
    ...
    }, [date4.value.format("YYYY/MM/DD")]), createVNode("div", {
...
var Month = {
  ...
  setup(props, {
    ...
    function genDay({
      ...
      const dayClass = getDayClass(date4);
      return createVNode("div", {
        "data-date": date4.format(props.format),
        "onClick": ($event) => emit("dayClick", date4, $event),
        "class": [ns + "__day", {
          disabled: type4 === "disabled"
        }, dayClass]
      }, [createVNode("span", null, [date4.format("D")])]);
    }
    function getDayClass(date4, i) {
      let classes = {};
      if (date4.isSame(dayjs(), "day")) {
        classes.today = true;
      }
      let value = isArray$1(props.modelValue) ? props.modelValue : [props.modelValue];
      if (value.some((_date) => _date && date4.isSame(_date, "day"))) {
        classes.active = true;
      }
      let {
        isStartSelect,
      ...
      if (rangeEndDate.value) {
        ...
        if (date4.isBetween(start, end, null, "[]")) {
          classes.covered = true;
        }
        if (date4.isSame(start, "day")) {
          classes["start-date"] = true;
        }
        if (date4.isSame(end, "day")) {
...
var GDatePicker$1 = defineComponent({
  name: "GDatePicker",
  props: {
    modelValue: {
  ...
  setup(props, {
    ...
    function onDayClick(date4, e) {
      if (isTypeDateRange.value) {
        if (isStartSelect) {
          isStartSelect = false;
          dayjs(date4).isBefore(props.modelValue[0]) ? emit("update:modelValue", [date4.toDate(), props.modelValue[0]]) : emit("update:modelValue", [props.modelValue[0], date4.toDate()]);
          onClose();
        } else {
          isStartSelect = true;
          emit("update:modelValue", [date4.toDate()]);
        }
      } else {
        emit("update:modelValue", date4.toDate());
        onClose();
    ...
    function genSingleCalendar(date4) {
      function onDoubleLeftClick() {
        date4.value = date4.value.subtract(1, "year");
      }
      function onLeftClick() {
        date4.value = date4.value.subtract(1, "month");
      }
      function onDoubleRightClick() {
        date4.value = date4.value.add(1, "year");
      }
      function onRightClick() {
        date4.value = date4.value.add(1, "month");
      }
      function genMonth(date5, i) {
    ...
    function getCalendar() {
      return createVNode(Transition, {
        ...
        default: () => [visible.value ? createVNode("div", {
          ...
          "class": [ns + "__footer"]
        }, [createVNode(GButton$1, {
          "size": "small",
          "onClick": clearDate
        }, {
          default: () => [createTextVNode("\u6E05\u9664")]
        }), isTypeDateRange.value ? null : createVNode(GButton$1, {
          "size": "small",
  ...
  render() {
    ...
    const startDateText = type4 === "daterange" ? modelValue[0] ? dayjs(modelValue[0]).format(format2) : "" : modelValue ? dayjs(modelValue).format(format2) : "";
    const endDateText = type4 === "daterange" ? modelValue[1] ? dayjs(modelValue[1]).format(format2) : "" : "";
    ...
    }, null), isTypeDateRange ? createVNode(Fragment, null, [createVNode("span", null, [createTextVNode("\u81F3")]), createVNode(_sfc_main$h, {
      "class": [ns + "__input"],
      "onClick": this.toggleShowCalendar,
      "modelValue": endDateText
    }, null)]) : null, clearIconShow.value && createVNode(_sfc_main$l, {
...
var GDatePicker = {
  install(app) {
    app.component(GDatePicker$1.name, GDatePicker$1);
  }
};
const defaultConfig = {
  multiple: false,
...
const _sfc_main$2 = /* @__PURE__ */ Object.assign(__default__$2, {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("li", {
        class: normalizeClass([ns2 + "__option", { active: unref(isInPath), checked: unref(isChecked) }]),
        onClick: _cache[0] || (_cache[0] = ($event) => onOptionClick(__props.node, _ctx.i))
      }, [
        createElementVNode("div", {
          class: normalizeClass([ns2 + "__option-left"])
        }, [
          unref(isMultiple) ? (openBlock(), createBlock(_sfc_main$b, {
            key: 0,
            class: normalizeClass([ns2 + "__checkbox"]),
        ...
        createElementVNode("div", {
          class: normalizeClass([ns2 + "__option-right"])
        }, [
          !__props.node.isLeaf ? (openBlock(), createBlock(_sfc_main$l, {
            key: 0,
            class: "g-icon-right"
          }, {
            default: withCtx(() => [
          ...
          unref(isChecked) ? (openBlock(), createBlock(_sfc_main$l, { key: 1 }, {
            default: withCtx(() => [
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("ul", {
        class: normalizeClass([ns2 + "__menu"])
      }, [
      ...
      return withDirectives((openBlock(), createElementBlock("div", {
        ...
        (openBlock(), createBlock(Teleport, {
          ...
          createVNode(Transition, { name: "cascader-menus" }, {
            default: withCtx(() => [
              withDirectives(createElementVNode("div", {
                class: normalizeClass([ns2 + "__menus"]),
                ref_key: "menusRef",
                ref: menusRef,
