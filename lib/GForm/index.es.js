...
import { reactive, toRefs, provide, openBlock, createElementBlock, normalizeClass, renderSlot, inject, ref, computed, onMounted, onBeforeUnmount, unref, toDisplayString, createCommentVNode, createElementVNode, nextTick } from "vue";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", {
          ...
          renderSlot(_ctx.$slots, "default"),
          validateState.value === "error" ? (openBlock(), createElementBlock("div", _hoisted_1, toDisplayString(validateMessage.value), 1)) : createCommentVNode("", true)
        ], 2)
      ], 2);
    };
  }
